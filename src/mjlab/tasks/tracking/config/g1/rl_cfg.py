...
def unitree_g1_trackingbfm_ppo_runner_cfg() -> RslRlOnPolicyRunnerCfg:
  """Create RL runner configuration for Unitree G1 multi-motion tracking task.

  Wider actor/critic networks for the harder multi-motion (Data10k-scale)
  setting; otherwise the same PPO hyperparameters as the single-motion runner.
  """
  return RslRlOnPolicyRunnerCfg(
    actor=RslRlModelCfg(
